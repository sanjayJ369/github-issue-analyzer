...
const Navbar = () => {
    ...
    const activeStyle = "text-foreground bg-accent/50"
        ...
        <nav className="border-b border-border bg-card/50 backdrop-blur-xl sticky top-0 z-50">
            <div className="container mx-auto px-3 sm:px-4 h-14 sm:h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                    <Button variant="ghost" size="sm" asChild className={location.pathname === "/" ? activeStyle : inactiveStyle}>
                        <Link to="/">Home</Link>
                    </Button>
                    <Button variant="ghost" size="sm" asChild className={location.pathname === "/about" ? activeStyle : inactiveStyle}>
